...
export const Dislike = ({ state, handleFunction }: Props) => {
  return (
    <button
      ...
      className={`hover:bg-red-default-dull transition-[bg, color] ${state ? "bg-red-default-dull text-red-default" : ""} hover:text-red-default flex h-full cursor-pointer items-center rounded-[10px] pr-2 pl-1 duration-300`}
    >
      <SvgArrowDown />
